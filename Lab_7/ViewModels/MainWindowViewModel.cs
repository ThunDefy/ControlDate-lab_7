...
namespace Lab_7.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        private List<Students> NewStudents()
        {
            ...
            {
                new Students("Студент 1", new int[3] {1,1,2}),
                new Students("Студент 2", new int[3] {0,0,1}),
                new Students("Студент 3", new int[3] {0,2,1}),
                new Students("Студент 4", new int[3] {1,0,1}),
                new Students("Студент 5", new int[3] {2,2,1}),
                new Students("Студент 6", new int[3] {0,1,1}),
                new Students("Студент 7", new int[3] {0,2,0}),
